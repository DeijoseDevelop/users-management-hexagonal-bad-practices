...
public final class EmailNotificationService {
  ...
  public void notifyUserCreated(final UserModel user, final String plainPassword) {
    final Map<String, String> tokens = buildBasicTokens(user);
  ...
  private Map<String, String> buildBasicTokens(final UserModel user) {
    // Usamos HashMap mutable para permitir agregar tokens específicos después
